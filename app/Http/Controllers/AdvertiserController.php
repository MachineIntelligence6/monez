...
class AdvertiserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $advertiser->report_coloumns = json_encode($advertiser->report_coloumns);
        // return $request;
        // if(session()->has('advertiser.io_files')){
        //     return $ioFiles = session()->get('advertiser.io_files');
        // }
        // $advertiser->documents_files = null;
        // $advertiser->io_files = null;
        // return $advertiser;
        $advertiser->save();
