                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                ...
                                <button type="button" class="btn btn-danger waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle mr-1"></i></i><a
                                        href="{{route('second', ['advertiser', 'create'])}}">Add New </a></button>
                            </div>
                            <!-- <div class="col-sm-8">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form class="d-inline"
                                                ...
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                                <button type="submit" class="mdi mdi-delete action-ico"
                                                        data-toggle="tooltip"
                                                        onclick="return confirm('Delete ! Are you sure?')"></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
