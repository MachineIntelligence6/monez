...
<form class="needs-validation" method="POST"
    action="{{ route('advertiser.update', ['advertiser' => $advertiser->id, 'currentedit' => 'accountinfo']) }}"
    ...
    <div class="form-category">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if ($lastSegment != 'accountinfo')
                <a href="{{ route('advertiser.edit', ['advertiser' => $advertiser->id, 'currentedit' => 'accountinfo']) }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        id="dbaId" name="advertiser_id" placeholder="Enter Advertiser ID"
                        value="{{ $advertiser->advertiser_id ?? old('advertiser_id') }}" />
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->company_name ?? old('company_name') }}">
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        id="regId" name="reg_id" placeholder="Enter Registration / National ID"
                        value="{{ $advertiser->reg_id ?? old('reg_id') }}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        id="vat" name="vat_id" placeholder="Enter VAT"
                        value="{{ $advertiser->vat_id ?? old('vat_id') }}">
                </div>
            </div> <!-- end col -->
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->website_url ?? old('website_url') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->account_email ?? old('account_email') }}">
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        name="" placeholder="Enter confirm account email" id="confemail"
                        data-autovalidate="false" oninput="confirmEmail()"
                        value="{{ $advertiser->account_email ?? old('account_email') }}">
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="pl-2">
                            <button type="button" @if ($lastSegment != 'accountinfo') disabled @endif
                                class="btn btn-secondary can-be-disabled"
                                onclick="generateRandomPassword(this)">Regenerate</button>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->address1 ?? old('address1') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->address2 ?? old('address2') }}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->city ?? old('city') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->state ?? old('state') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'accountinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->zipcode ?? old('zipcode') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                ...
                <select class="form-control" name="country" @if ($lastSegment != 'accountinfo') disabled @endif
                    id="country-dropdown"
                    onchange="setCountryCodeToPhone(this.options[this.selectedIndex].getAttribute('phone-code'))"
                    data-toggle="select2">
                    <option>Select Country</option>
                    @foreach ($countries as $key => $country)
                        <option value="{{ $country->title }}" @if (isset($advertiser) && $country->title == $advertiser->country) selected @endif
                ...
                <div class="col-md-6 h-100">
                    <div class="mb-3">
                        ...
                        <input type="file" name="io_files[]" class="dropify" data-height="200"
                            data-allowed-file-extensions="pdf" accept="application/pdf"
                            data-max-file-size="5M" /><br>
                    </div>
                </div>
                <div class="col-md-6 h-100">
                    <div class="mb-3">
...
<form class="needs-validation" method="POST"
    action="{{ route('advertiser.update', ['advertiser' => $advertiser->id, 'currentedit' => 'contactinfo']) }}"
    enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-category">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if ($lastSegment != 'contactinfo')
                <a href="{{ route('advertiser.edit', ['advertiser' => $advertiser->id, 'currentedit' => 'contactinfo']) }}"
                    class="edit-category-btn btn btn-secondary">
                    <span class="fas fa-edit mr-1"></span>
                    Edit Info
                </a>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'contactinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->acc_mng_first_name ?? old('acc_mng_first_name') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'contactinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->acc_mng_last_name ?? old('acc_mng_last_name') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" @if ($lastSegment != 'contactinfo') disabled @endif class="form-control"
                        ...
                        pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                        value="{{ $advertiser->acc_mng_email ?? old('acc_mng_email') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <div class="input-group-prepend" style="min-width: 150px;">
                            <select class="form-control " @if ($lastSegment != 'contactinfo') disabled @endif
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" @if ($lastSegment != 'contactinfo') disabled @endif class="form-control"
                            ...
                            value="{{ $advertiser->acc_mng_skype ?? old('acc_mng_skype') }}">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" @if ($lastSegment != 'contactinfo') disabled @endif class="form-control"
                            ...
                            pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                            value="{{ $advertiser->acc_mng_linkedin ?? old('acc_mng_linkedin') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
...
<form class="needs-validation" method="POST"
    action="{{ route('advertiser.update', ['advertiser' => $advertiser->id, 'currentedit' => 'operationinfo']) }}"
    enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-category">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if ($lastSegment != 'operationinfo')
                <a href="{{ route('advertiser.edit', ['advertiser' => $advertiser->id, 'currentedit' => 'operationinfo']) }}"
                    class="edit-category-btn btn btn-secondary">
                    <span class="fas fa-edit mr-1"></span>
                    Edit Info
                </a>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="number" @if ($lastSegment != 'operationinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->revenue_share ?? old('revenue_share') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="paymentTerms" class="form-label">Payment Terms </label><label
                        class="text-danger">*</label>
                    <select class="form-control" @if ($lastSegment != 'operationinfo') disabled @endif
                        data-toggle="select2" id="paymentTerms" name="payment_terms">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" @if ($lastSegment != 'operationinfo') disabled @endif class="form-control"
                        ...
                        pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                        value="{{ $advertiser->reporting_email ?? old('reporting_email') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <select class="form-control" @if ($lastSegment != 'operationinfo') disabled @endif
                            id="reportType" data-toggle="select2" name="report_type"
                            value="{{ $advertiser->report_type ?? old('report_type') }}">
                        ...
                        <div class="input-group-append">
                            <button type="button" @if ($lastSegment != 'operationinfo') disabled @endif
                                data-trigger="modal" data-target="report-type-modal" data-enable-target="reportType"
                                class="btn btn-secondary d-none display-on-valid">
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-merge">
                    <input type="text" @if ($lastSegment != 'operationinfo') disabled @endif
                        class="form-control remote-form-control" data-target-input="" style="pointer-events: none;"
                        id="reportColumns" name="reportColumns" placeholder="Define report columns">
                    <div class="input-group-append">
                        <button type="button" data-trigger="modal" data-target="define-report-columns-modal"
...
<form class="needs-validation" method="POST"
    action="{{ route('advertiser.update', ['advertiser' => $advertiser->id, 'currentedit' => 'financeinfo']) }}"
    enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-category">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if ($lastSegment != 'financeinfo')
                <a href="{{ route('advertiser.edit', ['advertiser' => $advertiser->id, 'currentedit' => 'financeinfo']) }}"
                    class="edit-category-btn btn btn-secondary">
                    <span class="fas fa-edit mr-1"></span>
                    Edit Info
                </a>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="billEmail" class="form-label">Billing / Finance Email</label><label
                        class="text-danger">*</label>
                    <input type="email" @if ($lastSegment != 'financeinfo') disabled @endif class="form-control"
                        ...
                        pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                        value="{{ $advertiser->billing_email ?? old('billing_email') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <span @if ($lastSegment != 'financeinfo') disabled @endif style="pointer-events: none;"
                            ...
                            id="bank">{{ $advertiser->bank_name ?? old('bank_name') }}</span>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'financeinfo') disabled @endif class="form-control"
                        ...
                        pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                        value="{{ $advertiser->paypal ?? old('paypal') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if ($lastSegment != 'financeinfo') disabled @endif class="form-control"
                        ...
                        value="{{ $advertiser->payoneer ?? old('payoneer') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid email format
                    </div>
