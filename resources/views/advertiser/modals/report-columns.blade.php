       ...
       <div class="modal-dialog modal-lg">
           <div class="modal-content shadow shadow-5">
               ...
               <div class="modal-body modal-scroll">
                   <div class="row">
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="dateColValue"   @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif  value="{{ $advertiser->reportColumns->date ??  old('date') }}"  name="dateColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="feedColValue"  @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif  value="{{ $advertiser->reportColumns->feed ??  old('feed') }}"  name="feedColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="subidColValue"  @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif   value="{{ $advertiser->reportColumns->subid ??  old('subid') }}"  name="subidColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="countryColValue"  @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif   value="{{ $advertiser->reportColumns->country ??  old('country') }}"  name="countryColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="totalSearchesColValue"  @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif   value="{{ $advertiser->reportColumns->total_searches ??  old('total_searches') }}"  name="totalSearchesColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="monitizedSearchesColValue"  @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif   value="{{ $advertiser->reportColumns->monitized_searches ??  old('monitized_searches') }}"  name="monitizedSearchesColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="paidClicksColValue" @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif   value="{{ $advertiser->reportColumns->paid_clicks ??  old('paid_clicks') }}"  name="paidClicksColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
                       ...
                       <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" id="revenueColValue"  @if($lastSegment == 'operationinfo' || $lastSegment == 'create') @else disabled @endif   value="{{ $advertiser->reportColumns->revenue ??  old('revenue') }}"  name="revenueColValue">
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">
                               You must enter valid input
                           </div>
               ...
               <div class="modal-footer border-top">
                   ...
                   @if($lastSegment!='view')
                   <button type="button" class="btn btn-primary" onclick="onSaveColumnsModal()" data-dismiss="modal">Save Details</button>
                   @endif
               </div>
           </div>
       </div>
