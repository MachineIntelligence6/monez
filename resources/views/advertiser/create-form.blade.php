<div id="btnwizard">
    ...
    <div class="tab-pane {{ $advActiveTab == 'contactInfoTab' ? 'active show' : '' }} fade" id="contactInfoTab">
        ...
        <form class="needs-validation" id="contactInfoform" method="post" action="{{ route('advertiser.store.all') }}" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="number" class="form-control ml-2" id="amPhone" name="acc_mng_phone" placeholder="Enter phone number" value="{{ session()->get('advertiser.acc_mng_phone') }}" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control" id="amLinkedIn" name="acc_mng_linkedin" placeholder="Url" pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})" value="{{ session()->get('advertiser.acc_mng_linkedin') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
