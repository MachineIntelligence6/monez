<div id="btnwizard">
    <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
        <li class="nav-item">
            <a data-target="#accountInfoTab" data-toggle="tab" id="accountInfoTabbutton"
               ...
               class="nav-link rounded-0 {{ $advActiveTab == 'accountInfoTab' ? 'active' : '' }} pt-2 pb-2">
        ...
        <li class="nav-item">
            <a data-target="#contactInfoTab" data-toggle="tab" id="contactInfoTabbutton"
               style="pointer-events: none; user-select: none;"
               class="nav-link rounded-0 {{ $advActiveTab == 'contactInfoTab' ? 'active' : '' }} pt-2 pb-2">
    ...
    <div class="tab-content mb-0 b-0 pt-0">
        ...
        <div class="tab-pane {{ $advActiveTab == 'accountInfoTab' ? 'active show' : '' }} fade" id="accountInfoTab">
            <form class="needs-validation" id="accountInfoform" method="post"
                  action="{{ route('advertiser.store.account') }}" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="dbaId" name="advertiser_id"
                                       data-check-unique="oninput"
                                       data-invalid-message="Advertiser ID already registered."
                                       data-unique-path="{{ route('advertiser.check-unique-id') }}"
                                       placeholder="Enter Advertiser ID" required
                                       value="{{ session()->get('advertiser.advertiser_id') }}"/>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="companyName" name="company_name"
                                   ...
                                   value="{{ session()->get('advertiser.company_name') }}">
                            <div class="valid-feedback">Valid.</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="regId" name="reg_id"
                                   ...
                                   value="{{ session()->get('advertiser.reg_id') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="vat" class="form-label">VAT ID</label>
                            <input type="text" class="form-control" id="vat" name="vat_id" placeholder="Enter VAT"
                                   value="{{ session()->get('advertiser.vat_id') }}">
                        </div>
                    </div> <!-- end col -->
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="website-url-input" name="website_url"
                                   ...
                                   required value="{{ session()->get('advertiser.website_url') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="accEmail" name="account_email"
                                   ...
                                   data-unique-path="{{ route('advertiser.check-unique-email') }}"
                                   pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                                   required value="{{ session()->get('advertiser.account_email') }}">
                            <div class="valid-feedback">Valid.</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="password-input-field" class="form-control"
                                       ...
                                       value="{{ session()->get('advertiser.account_password') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="city" name="city" placeholder="Enter city"
                                   required value="{{ session()->get('advertiser.city') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="state_id" name="state"
                                   ...
                                   value="{{ session()->get('advertiser.state') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <select class="form-control" name="country" id="country-dropdown" data-toggle="select2"
                            ...
                            @foreach ($countries as $key => $country)
                                <option value="{{ $country->title }}"
                                        @if ( session()->has('advertiser.country') && $country->id == session()->get('advertiser.country')) selected
                                        @endif
    ...
    <div class="tab-pane {{ $advActiveTab == 'contactInfoTab' ? 'active show' : '' }} fade" id="contactInfoTab">
        ...
        <form class="needs-validation" id="contactInfoform" method="post" action="{{ route('advertiser.store.all') }}"
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="amFirstName" name="acc_mng_first_name"
                               ...
                               value="{{ session()->get('advertiser.acc_mng_first_name') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="amLastName" name="acc_mng_last_name"
                               ...
                               value="{{ session()->get('advertiser.acc_mng_last_name') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="amEmail" name="acc_mng_email"
                               ...
                               pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                               required value="{{ session()->get('advertiser.acc_mng_email') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="amSkype" name="acc_mng_skype"
                                   placeholder="@username" value="{{ session()->get('advertiser.acc_mng_skype') }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control" id="amLinkedIn" name="acc_mng_linkedin"
                                   placeholder="Url"
                                   pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                                   value="{{ session()->get('advertiser.acc_mng_linkedin') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
            ...
            <div class="row px-2 justify-content-between">
                <button class="btn btn-secondary ml-1 previous-tab-btn" id="previous-tab" type="button">Previous
                </button>
