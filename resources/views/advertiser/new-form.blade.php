...
<div id="btnwizard">
    <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
        ...
        <li class="nav-item">
            <a data-target="#operationsInfoTab" data-toggle="tab" id="operationInfoTabbutton"
                class="nav-link rounded-0 pt-2 pb-2">
                <i class="mdi mdi-office-building mr-2"></i>
                Operations Info
            </a>
        ...
        <li class="nav-item">
            <a data-target="#financeInfoTab" data-toggle="tab" id="financeInfoTabbutton"
                class="nav-link rounded-0 pt-2 pb-2">
                <i class="mdi mdi-office-building mr-2"></i>
                Finance Info
            </a>
    ...
    <div class="tab-content mb-0 b-0 pt-0">
        ...
        <div class="tab-pane {{ $activeTab == 'accountInfoTab' ? 'active show' : '' }} fade" id="accountInfoTab">
            <form class="needs-validation" id="accountInfofor" method="post"
                action="{{ route('advertiser.storeAccountInfo') }}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="dbaId" class="form-label">Advertiser ID</label><label
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="dbaId" name="dbaId"
                                    data-check-unique="oninput" data-invalid-message="Advertiser ID already registered."
                                    data-unique-path="{{ route('check.unique.value') }}"
                                    placeholder="Enter Advertiser ID" required
                                    value="{{ session()->get('advertiser.dbaId') }}" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="companyName" name="companyName"
                                ...
                                value="{{ session()->get('advertiser.companyName') }}">
                            <div class="valid-feedback">Valid.</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="regId" name="regId"
                                ...
                                value="{{ session()->get('advertiser.regId') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="vat" name="vat"
                                placeholder="Enter VAT" value="{{ session()->get('advertiser.vat') }}">
                        </div>
                    </div> <!-- end col -->
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="url" class="form-label">Website</label><label class="text-danger">*</label>
                            <input type="text" class="form-control" id="website-url-input" name="url"
                                placeholder="Enter website url"
                                pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                                required value="{{ session()->get('advertiser.url') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="accEmail" name="accEmail"
                                ...
                                data-unique-path="{{ route('check.unique.accEmail') }}"
                                pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                                required value="{{ session()->get('advertiser.accEmail') }}">
                            <div class="valid-feedback">Valid.</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="password-input-field" class="form-control"
                                    ...
                                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}" value="{{ session()->get('advertiser.password') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address1" name="address1"
                                ...
                                value="{{ session()->get('advertiser.address1') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address2" name="address2"
                                ...
                                value="{{ session()->get('advertiser.address2') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="city" name="city_id"
                                ...
                                value="{{ session()->get('advertiser.city_id') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="state_id" name="state_id"
                                ...
                                value="{{ session()->get('advertiser.state_id') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="zipCode" name="zipCode"
                                placeholder="Enter zip / code" value="{{ session()->get('advertiser.zipCode') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="country_id" id="country-dropdown" data-toggle="select2"
                            required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 h-100 mb-3">
                        ...
                        <input type="file" name="ios[]" class="dropify" data-height="200"
                            data-allowed-file-extensions="pdf" accept="application/pdf" data-max-file-size="5M"
                            multiple />
                    </div>
                    <div class="col-md-6 h-100 mb-3">
                        <label for="documents" class="form-label">Documents</label>
                        <input type="file" name="documents[]" class="dropify" data-height="200"
                            data-allowed-file-extensions="pdf" accept="application/pdf" data-max-file-size="5M"
                            multiple />
                    </div>
                </div>
                <div class="row px-2 justify-content-between">
                    <a href="{{ route('advertiser.index') }}" class="btn btn-secondary ml-1"
        ...
        <div class="tab-pane {{ $activeTab == 'contactInfoTab' ? 'active show' : '' }} fade" id="contactInfoTab">
            ...
            <form class="needs-validation" id="contactInfoform" method="post"
                action="{{ route('advertiser.storeContactInfo') }}" enctype="multipart/form-data" novalidate>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="amFirstName" name="amFirstName"
                                ...
                                value="{{ session()->get('advertiser.amFirstName') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="amLastName" name="amLastName"
                                ...
                                value="{{ session()->get('advertiser.amLastName') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="amEmail" class="form-label"> Email</label><label
                                class="text-danger">*</label>
                            <input type="email" class="form-control" id="amEmail" name="amEmail"
                                placeholder="Enter email"
                                pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                                required value="{{ session()->get('advertiser.amEmail') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control ml-2" id="amPhone" name="amPhone"
                                    placeholder="Enter phone number" value="{{ session()->get('advertiser.amPhone') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="amSkype" name="amSkype"
                                    placeholder="@username" value="{{ session()->get('advertiser.amSkype') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" class="form-control" id="amLinkedIn" name="amLinkedIn"
                                    placeholder="Url"
                                    pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                                    value="{{ session()->get('advertiser.amLinkedIn') }}">
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">
                                    You must enter valid input
                                </div>
        ...
        <div class="tab-pane {{ $activeTab == 'operationsInfoTab' ? 'active show' : '' }} fade"
            id="operationsInfoTab">
            <form class="needs-validation" id="operationInfoform" method="post"
                action="{{ route('advertiser.storeOperationInfo') }}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control"
                                onchange="this.value = Math.min(this.value, 100)" id="revSharePer" name="revSharePer"
                                placeholder="Enter Revenue Share (%)" required value="{{ session()->get('advertiser.revSharePer') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="paymentTerms" class="form-label">Payment Terms </label><label
                                class="text-danger">*</label>
                            <div class="input-group">
                                <select class="form-control" data-toggle="select2" id="paymentTerms"
                                    name="paymentTerms" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="reportEmail" class="form-label">Reporting Email</label><label
                                class="text-danger">*</label>
                            <input type="email" class="form-control" id="reportEmail" name="form_reportEmail"
                                placeholder="Enter reporting email"
                                pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                                required value="{{ session()->get('advertiser.reportEmail') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" class="form-control" style="pointer-events: none;"
                                id="reportColumns" name="reportColumns" placeholder="Define report details">
                            <input type="text" class="form-control d-none" id="reportColumnsId"
                                name="report_columns_id" value="{{ session()->get('advertiser.report_columns_id') }}">
                            <div class="input-group-append">
                                <button type="button" data-trigger="modal" data-target="report-details-modal"
                        ...
                        <select class="form-control" data-toggle="select2" id="successManager" name="team_member_id"
                            ...
                            @foreach ($availableTeamMembers as $key => $teamMember)
                                <option value="{{ $teamMember->id }}"
                                    @if ( session()->get('advertiser.team_member_id') == $teamMember->id) selected @endif>
        ...
        <div class="tab-pane {{ $activeTab == 'financeInfoTab' ? 'active show' : '' }}" id="financeInfoTab">
                ...
                <form class="needs-validation" id="financeInfoform" method="post"
                    action="{{ route('advertiser.storeFinanceInfo') }}" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="billEmail" name="billEmail"
                            ...
                            pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                            required value="{{ session()->get('advertiser.billEmail') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" style="pointer-events: none;" tabindex="-1" class="form-control"
                                id="bank" name="bank" placeholder="Enter Bank account" value="{{ session()->get('advertiser.bank') }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="paypal" name="paypal"
                            ...
                            pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                            value="{{ session()->get('advertiser.paypal') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="payoneer" name="payoneer"
                            ...
                            value="{{ session()->get('advertiser.payoneer') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid email format
                        </div>
