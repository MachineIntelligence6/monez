                            ...
                            if (response.status === 'error') {
                                ...
                                $.each(response.data, function(key, value) {
                                    ...
                                    append($('<div class="dropdown-item">' +
                                        '<div class="custom-control custom-checkbox">' +
                                        '<input type="checkbox" name="feeds-channels" class="custom-control-input" id="feed' +
                                        i + '" value="' + value.id + '">' +
                                        '<label class="custom-control-label w-100" for="feed' +
                                        i + '">' + value.feedId + '</label>' +
                                        '</div>' +
                                        '</div>'));
                                });
                            }
