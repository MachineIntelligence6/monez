                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" @if($lastSegment=='create' ) autoGenerate required @endif id="password-input-field" value="{{($lastSegment=='create') ? old('password') : ''}}" @if($condition==$lastSegment || $condition==$Segmenttwo) disabled @endif class="form-control" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
