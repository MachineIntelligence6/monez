            ...
            <div class="modal-body modal-scroll">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="dailyCap" name="dailyCap" placeholder="Daily Cap">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="acceptedGeos" name="acceptedGeos" placeholder="Accepted Geos">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="searchEngine" name="searchEngine" placeholder="Search Engine / Ads">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="feedType" name="feedType" placeholder="Feed Type">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="trafficType" name="trafficType" placeholder="Traffic Type">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="trafficSources" name="trafficSources" placeholder="Traffic Sources">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="browsers" name="browsers" placeholder="Browsers">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="otherRequirements" name="otherRequirements" placeholder="Other Requirements Like TQ, RPM, CPC, CTR etc">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
