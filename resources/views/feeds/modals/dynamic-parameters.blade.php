            ...
            <div class="modal-body modal-scroll">
                ...
                @if(isset($feed))
                    ...
                    <div class="d-flex w-100 dynamicParameter mb-3" id="dynamicParameterSample" style="max-width: 100%; overflow-x: hidden;">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" @if($condition == $lastSegment) disabled @endif id="paramValue" value="{{old('dy_paramValue', $parts[1] ?? '')}}" name="dy_paramValue[]" placeholder="Enter Channel Parameter" />
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
