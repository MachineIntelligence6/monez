...
<form class="needs-validation" method="POST"
      action="{{ route('publisher.update', ['publisher'=>$publisher->id , 'currentedit' => 'accountinfo']) }}"
    ...
    <div class="form-category">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if($lastSegment!='accountinfo')
                <a href="{{ route('publisher.edit', ['publisher'=>$publisher->id , 'currentedit' => 'accountinfo']) }}"
                   class="edit-category-btn btn btn-secondary">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control"
                           id="companyName" name="company_name" placeholder="Enter Company / Legal Name"
                           value="{{ $publisher->company_name ??  old('company_name') }}">
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control" id="regId"
                           name="reg_id" placeholder="Enter Registration / National ID"
                           value="{{ $publisher->reg_id ??  old('reg_id') }}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="vat" class="form-label">VAT ID</label>
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control" id="vat"
                           name="vat_id" placeholder="Enter VAT" value="{{ $publisher->vat_id ??  old('vat_id') }}">
                </div>
            </div> <!-- end col -->
            <div class="col-md-4">
                <div class="mb-3">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control"
                           id="accEmail" oninput="confirmEmail()" name="account_email" placeholder="Enter account email"
                           pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                           value="{{ $publisher->account_email ??  old('account_email') }}">
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control" name=""
                           placeholder="Enter confirm account email" id="confemail" data-autovalidate="false"
                           oninput="confirmEmail()" value="{{ $publisher->account_email ??  old('account_email') }}">
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <input type="password" @if($lastSegment!='accountinfo' ) disabled
                               @endif id="password-input-field" class="form-control"
                        ...
                        <div class="pl-2">
                            <button type="button" @if($lastSegment!='accountinfo' ) disabled
                                    @endif class="btn btn-secondary can-be-disabled"
                                    onclick="generateRandomPassword(this)">Regenerate
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        Your password must contain least 8 characters, at least one number and one uppercase and
                        lowercase
                        letter.
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control"
                           id="address1" name="address1" placeholder="Enter address line 1"
                           value="{{ $publisher->address1 ??  old('address1') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control"
                           id="address2" name="address2" placeholder="Enter address line 2"
                           value="{{ $publisher->address2 ??  old('address2') }}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <!-- <label for="cwebsite" class="form-label">Address Line 1</label> -->
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control" id="city"
                           name="city" placeholder="Enter city" value="{{ $publisher->city ??  old('city') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <!-- <label for="cwebsite" class="form-label">Address Line 1</label> -->
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control"
                           id="state_id" name="state" placeholder="Enter state / province"
                           value="{{ $publisher->state ??  old('state') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='accountinfo' ) disabled @endif class="form-control"
                           ...
                           value="{{ $publisher->zipcode ??  old('zipcode') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                ...
                <select class="form-control" name="country" @if($lastSegment!='accountinfo' ) disabled
                        @endif id="country-dropdown"
                        onchange="setCountryCodeToPhone(this.options[this.selectedIndex].getAttribute('phone-code'))"
                        data-toggle="select2">
                    <option>Select Country</option>
                    @foreach ($countries as $key => $country)
                        <option value="{{$country->title}}"
                                @if (isset($publisher) && $country->title == $publisher->country) selected
                                @endif phone-code="{{$country -> countryCode}}">{{$country->title}}</option>
                    @endforeach
                </select>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4 mb-3">
                <label for="successManager" class="form-label">Success Manager</label><label
                    class="text-danger">*</label>
                <select class="form-control" @if($lastSegment!='accountinfo' ) disabled @endif data-toggle="select2"
                        id="successManager" name="team_member_id">
                    @foreach ($availableTeamMembers as $key => $teamMember)
                        <option value="{{$teamMember->id}}"
                                @if ($teamMember->id == $publisher->team_member_id) selected @endif>{{$teamMember->name}}</option>
                    @endforeach
...
<form class="needs-validation" method="POST"
      action="{{ route('publisher.update', ['publisher'=>$publisher->id , 'currentedit' => 'contactinfo']) }}"
      enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-category">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if($lastSegment!='contactinfo')
                <a href="{{ route('publisher.edit', ['publisher'=>$publisher->id ,'currentedit' => 'contactinfo']) }}"
                   class="edit-category-btn btn btn-secondary">
                    <span class="fas fa-edit mr-1"></span>
                    Edit Info
                </a>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='contactinfo' ) disabled @endif class="form-control"
                           id="amFirstName" name="acc_mng_first_name" placeholder="Enter first name"
                           value="{{ $publisher->acc_mng_first_name ??  old('acc_mng_first_name') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='contactinfo' ) disabled @endif class="form-control"
                           id="amLastName" name="acc_mng_last_name" placeholder="Enter last name"
                           value="{{ $publisher->acc_mng_last_name ??  old('acc_mng_last_name') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" @if($lastSegment!='contactinfo' ) disabled @endif class="form-control"
                           id="amEmail" name="acc_mng_email" placeholder="Enter email"
                           pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                           value="{{ $publisher->acc_mng_email ??  old('acc_mng_email') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <div class="input-group-prepend" style="min-width: 80px;">
                            <select class="form-control " @if($lastSegment!='contactinfo' )
                disabled
            @endif id="phone-code-dropdown" data-toggle="select2">
                                @foreach ($countries as $key => $country)
        ...
        <input type="number" @if($lastSegment!='contactinfo' )
                disabled
            @endif class="form-control ml-2" id="amPhone" name="amPhone" value="{{ $publisher->amPhone ??  old('amPhone') }}" placeholder="Enter phone number">
                    </div>
                </div>
            </div> -->
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <div class="input-group-prepend" style="min-width: 150px;">
                            <select class="form-control " @if($lastSegment!='contactinfo' ) disabled
                        ...
                        <input type="number" @if($lastSegment!='contactinfo' ) disabled @endif class="form-control ml-2"
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" @if($lastSegment!='contactinfo' ) disabled @endif class="form-control"
                               id="amSkype" name="acc_mng_skype" placeholder="@username"
                               value="{{ $publisher->acc_mng_skype ??  old('acc_mng_skype') }}">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" @if($lastSegment!='contactinfo' ) disabled @endif class="form-control"
                               id="amLinkedIn" name="acc_mng_linkedin" placeholder="Url"
                               pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                               value="{{ $publisher->acc_mng_linkedin ??  old('acc_mng_linkedin') }}">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">
                            You must enter valid input
                        </div>
...
<form class="needs-validation" method="POST"
      action="{{ route('publisher.update', ['publisher'=>$publisher->id , 'currentedit' => 'operationinfo']) }}"
      enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-category">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if($lastSegment!='operationinfo')
                <a href="{{ route('publisher.edit', ['publisher'=>$publisher->id ,'currentedit' => 'operationinfo']) }}"
                   class="edit-category-btn btn btn-secondary">
                    <span class="fas fa-edit mr-1"></span>
                    Edit Info
                </a>
                ...
                <div class="row display-on-edit">
                    <div class="col-md-6 h-100">
                        <div class="mb-3">
                            ...
                            <input type="file" name="io_files[]" class="dropify" data-height="200"
                                   data-allowed-file-extensions="pdf" accept="application/pdf" data-max-file-size="5M"
                                   multiple/><br>
                        </div>
                    </div>
                    <div class="col-md-6 h-100">
                        <div class="mb-3">
                            ...
                            <input type="file" name="document_files[]" class="dropify" data-height="200"
                                   data-allowed-file-extensions="pdf" accept="application/pdf" data-max-file-size="5M"
                                   multiple/><br>
                        </div>
                    </div>
                        ...
                        <div class="border h-100 rounded-sm p-2">
                            @if ($publisher->io_path)
                                @foreach ($publisher->io_path as $key => $file)
                                    <a href="{{ route('publisher.download-file', ['publisher' => $publisher->id, 'fileNo' => $key, 'type'=>'io']) }}">{{ $file->name }}</a>
                        ...
                        <div class="border h-100 rounded-sm p-2">
                            @if ($publisher->documents_path)
                                @foreach ($publisher->documents_path as $key => $file)
                                    <a href="{{ route('publisher.download-file', ['publisher' => $publisher->id, 'fileNo' => $key, 'type'=>'document']) }}">{{ $file->name}}</a>
                                    <span>Uploaded On: {{ \Carbon\Carbon::parse($file->time)->format('d-m-Y H:i:s') }}</span>
                                    <br><br>
                                @endforeach
                            @else
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="revSharePer" class="form-label">Revenue Share (%)</label><label
                        class="text-danger">*</label>
                    <input type="number" @if($lastSegment!='operationinfo' ) disabled @endif class="form-control"
                           onchange="this.value = Math.min(this.value, 100)" id="revSharePer" name="revenue_share"
                           placeholder="Enter Revenue Share (%)"
                           value="{{ $publisher->revenue_share ??  old('revenue_share') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="paymentTerms" class="form-label">Payment Terms </label><label
                        class="text-danger">*</label>
                    <select class="form-control" @if($lastSegment!='operationinfo' ) disabled
                            @endif data-toggle="select2" id="paymentTerms" name="payment_terms">
                        <option value="" disabled>Select Payment Term</option>
                        @foreach ($paymentTermsValues as $ptv)
                            <option value='{{$ptv}}'
                                    @if (isset($publisher) && $ptv==$publisher->payment_terms) selected @endif>
                                Net {{$ptv}}</option>
                        @endforeach
                    </select>
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="form_reportEmail" class="form-label">Reporting Email</label><label
                        class="text-danger">*</label>
                    <input type="email" @if($lastSegment!='operationinfo' ) disabled @endif class="form-control"
                           id="reportEmail" name="reporting_email" placeholder="Enter reporting email"
                           pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                           value="{{ $publisher->reporting_email ??  old('reporting_email') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
...
<form class="needs-validation" method="POST"
      action="{{ route('publisher.update', ['publisher'=>$publisher->id , 'currentedit' => 'financeinfo']) }}"
      enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-category">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @if($lastSegment!='financeinfo')
                <a href="{{ route('publisher.edit', ['publisher'=>$publisher->id ,'currentedit' => 'financeinfo']) }}"
                   class="edit-category-btn btn btn-secondary">
                    <span class="fas fa-edit mr-1"></span>
                    Edit Info
                </a>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="email" @if($lastSegment!='financeinfo' ) disabled @endif class="form-control"
                           id="billEmail" name="billing_email" placeholder="Enter billing / financial email"
                           pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                           value="{{ $publisher->billing_email ??  old('billing_email') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid input
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <!--<input type="text" @if($lastSegment!='financeinfo' )
                            disabled
                        @endif style="pointer-events: none;" value="{{ $publisher->bankDetails->bank_name ??  old('bank_name') }}" class="form-control remote-form-control" data-targetInput="bankNameInput" id="bank" name="bank" placeholder="Enter Bank account" >-->
                        <span @if($lastSegment!='financeinfo' ) disabled @endif style="pointer-events: none;"
                              class="form-control remote-form-control" data-targetInput="bankNameInput"
                              id="bank">{{ $publisher->bank_name ?? old('bank_name') }}</span>

                        <div class="input-group-append">
                            <button type="button" data-trigger="modal" data-target="add-bank-details-modal"
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='financeinfo' ) disabled @endif class="form-control"
                           id="paypal" name="paypal" placeholder="Enter Paypal account"
                           pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                           value="{{ $publisher->paypal ??  old('paypal') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" @if($lastSegment!='financeinfo' ) disabled @endif class="form-control"
                           id="payoneer" name="payoneer" placeholder="Enter payoneer account"
                           value="{{ $publisher->payoneer ??  old('payoneer') }}">
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">
                        You must enter valid email format
                    </div>
