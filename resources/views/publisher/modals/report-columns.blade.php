...
<div class="modal fade" id="define-report-columns-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content shadow shadow-5">
            <form id="reportColoumnsForm" action="{{ route('publisher.store.report') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="modal-body modal-scroll">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="dateColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->date ?? old('date') }}" name="dateColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="feedColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->feed ??  old('feed') }}" name="feedColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="subidColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->subid ??  old('subid') }}" name="subidColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="countryColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->country ??  old('country') }}" name="countryColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="totalSearchesColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->total_searches ??  old('total_searches') }}" name="totalSearchesColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="monitizedSearchesColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->monitized_searches ??  old('monitized_searches') }}" name="monitizedSearchesColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="paidClicksColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->paid_clicks ??  old('paid_clicks') }}" name="paidClicksColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required id="revenueColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{ $publisher->report_coloumns->revenue ??  old('revenue') }}" name="revenueColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
