    ...
    <div class="modal fade" id="report-details-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content shadow shadow-5">
                <form id="reportTypeForm" action="{{ route('publisher.store.report') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                ...
                <div class="modal-body modal-scroll">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <select class="form-control" id="reportType" data-toggle="select2" name="reportType" required value="{{session()->get('publisher.report_type')}}">
                        ...
                        <div class="col-12 mb-3 d-none report-creds-input api-input-group">
                            ...
                            <input type="text" class="form-control" @if($lastSegment!='view' ) @else disabled @endif id="apiKey" value="{{session()->get('publisher.api_key')}}" name="api_key">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-12 mb-3 d-none report-creds-input dashboard-input-group">
                            ...
                            <input type="text" class="form-control" id="dashboardPath" value="{{session()->get('publisher.dashboard_path')}}" name="dashboard_path">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-12 mb-3 d-none report-creds-input email-input-group">
                            ...
                            <input type="email" class="form-control" @if($lastSegment!='view' ) @else disabled @endif id="reportEmail" value="{{session()->get('publisher.email')}}" name="email">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-12 mb-3 d-none report-creds-input email-input-group">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="reportPassword" @if($lastSegment!='view' ) @else disabled @endif class="form-control" value="{{session()->get('publisher.password')}}" name="password">
                        ...
                        <div class="col-12 mb-3 d-none report-creds-input gdrive-input-group">
                            ...
                            <input type="email" class="form-control" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.gdrive_email')}}" id="gdriveEmail" name="gdrive_email">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-12 mb-3 d-none report-creds-input gdrive-input-group">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="gdrivePassword" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.gdrive_password')}}" class="form-control" name="gdrive_password">
                                <div class="input-group-append" data-password="false">
                                    <div class="input-group-text btn">
                                        <span class="password-eye"></span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="dateColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.date')}}" name="dateColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="feedColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.feed')}}" name="feedColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="subidColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.subid')}}" name="subidColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="countryColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.country')}}" name="countryColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="totalSearchesColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.total_searches')}}" name="totalSearchesColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="monitizedSearchesColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.monitized_searches')}}" name="monitizedSearchesColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="paidClicksColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.paid_clicks')}}" name="paidClicksColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="revenueColValue" @if($lastSegment!='view' ) @else disabled @endif value="{{session()->get('publisher.report_coloumns.revenue')}}" name="revenueColValue">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
