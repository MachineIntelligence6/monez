                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                ...
                                <a href="{{route('second', ['publisher', 'create'])}}"
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap table-striped" id="products-datatable">
                                ...
                                @foreach($publishers as $publisher)
                                    <tr>
                                        <td>{{ $publisher->company_name}} ({{ $publisher->publisher_id }})</td>
                                        <td>{{ $publisher->website_url }}</td>
                                        <td>{{ $publisher->account_email }}</td>
                                        <td>{{ $publisher->acc_mng_first_name }} {{ $publisher->acc_mng_last_name }}</td>
                                        <td>{{ $publisher->teamMember ? $publisher->teamMember->name : '--' }}</td>
                                        <td>
                                            <!-- <a class="btn bg-secondary text-white">View Info</a> -->
                                            <a href="{{route('publisher.show', $publisher)}}" class="mx-1"> View
                                                Info</a>
                                        </td>
                                    </tr>
                                @endforeach
