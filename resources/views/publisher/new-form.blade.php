                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control ml-2" id="amPhone" name="acc_mng_phone" placeholder="Enter phone number" value="{{ session()->get('publisher.acc_mng_phone') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control" data-toggle="select2" id="successManager" name="user_id" required>
                            ...
                            <option value="{{ $teamMember->id }}" @if ( session()->get('publisher.user_id') == $teamMember->id) selected @endif>
                                {{ $teamMember->name }}
                            </option>
                            @endforeach
