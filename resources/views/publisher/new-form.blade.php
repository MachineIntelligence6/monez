...
<div id="btnwizard">
    <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
        <li class="nav-item">
            <a data-target="#accountInfoTab" data-toggle="tab" id="accountInfoTabbutton" style="pointer-events: none; user-select: none;" class="nav-link rounded-0 {{ $pubActiveTab == 'accountInfoTab' ? 'active' : '' }} pt-2 pb-2">
                <i class="mdi mdi-office-building mr-2"></i>
                Account Info
            </a>
        </li>
        <li class="nav-item">
            <a data-target="#contactInfoTab" data-toggle="tab" id="contactInfoTabbutton" style="pointer-events: none; user-select: none;" class="nav-link rounded-0 {{ $pubActiveTab == 'contactInfoTab' ? 'active' : '' }} pt-2 pb-2">
    ...
    <div class="tab-content mb-0 b-0 pt-0">
        ...
        <div class="tab-pane {{ $pubActiveTab == 'accountInfoTab' ? 'active show' : '' }} fade" id="accountInfoTab">
            <form class="needs-validation" id="accountInfoform" method="post" action="{{ route('publisher.store.account') }}" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="dbaId" name="publisher_id" data-check-unique="oninput" data-invalid-message="publisher ID already registered." data-unique-path="{{ route('publisher.check-unique-id') }}" placeholder="Enter publisher ID" required value="{{ session()->get('publisher.publisher_id') }}" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="companyName" name="company_name" placeholder="Enter Company / Legal Name" required value="{{ session()->get('publisher.company_name') }}">
                            <div class="valid-feedback">Valid.</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="regId" name="reg_id" placeholder="Enter Registration / National ID" value="{{ session()->get('publisher.reg_id') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="vat" class="form-label">VAT ID</label>
                            <input type="text" class="form-control" id="vat" name="vat_id" placeholder="Enter VAT" value="{{ session()->get('publisher.vat_id') }}">
                        </div>
                    </div> <!-- end col -->
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="url" class="form-label">Website</label><label class="text-danger">*</label>
                            <input type="text" class="form-control" id="website-url-input" name="website_url" placeholder="Enter website url" pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})" required value="{{ session()->get('publisher.website_url') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="accEmail" name="account_email" placeholder="Enter account email" oninput="confirmEmail()" data-check-unique="oninput" data-invalid-message="Email already registered." data-unique-path="{{ route('publisher.check-unique-email') }}" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" required value="{{ session()->get('publisher.account_email') }}">
                            <div class="valid-feedback">Valid.</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="" data-autovalidate="false" placeholder="Enter confirm account email" required id="confemail" oninput="confirmEmail()" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" required value="{{ session()->get('publisher.account_email') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="password-input-field" class="form-control" name="account_password" placeholder="Enter password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}" value="{{ session()->get('publisher.account_password') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address1" name="address1" placeholder="Enter address line 1" required value="{{ session()->get('publisher.address1') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address2" name="address2" placeholder="Enter address line 2" value="{{ session()->get('publisher.address2') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <!-- <label for="cwebsite" class="form-label">Address Line 1</label> -->
                            <input type="text" class="form-control" id="city" name="city" placeholder="Enter city" required value="{{ session()->get('publisher.city') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <!-- <label for="cwebsite" class="form-label">Address Line 1</label> -->
                            <input type="text" class="form-control" id="state_id" name="state" placeholder="Enter state / province" value="{{ session()->get('publisher.state') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <!-- <label for="cwebsite" class="form-label">Address Line 1</label> -->
                            <input type="text" class="form-control" id="zipCode" name="zipcode" placeholder="Enter zip / code" value="{{ session()->get('publisher.zipcode') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="country" id="country-dropdown" data-toggle="select2" required>
                            ...
                            <option value="{{ $country->title }}" @if ( session()->has('publisher.country') && $country->id == session()->get('publisher.country')) selected @endif
                ...
                <div class="row px-2 justify-content-between">
                    <a href="{{ route('publisher.index') }}" class="btn btn-secondary ml-1" type="button">Cancel</a>
        ...
        <div class="tab-pane {{ $pubActiveTab == 'contactInfoTab' ? 'active show' : '' }} fade" id="contactInfoTab">
            ...
            <form class="needs-validation" id="contactInfoform" method="post" action="{{ route('publisher.store.contact') }}" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="amFirstName" class="form-label">First Name </label><label class="text-danger">*</label>
                            <input type="text" class="form-control" id="amFirstName" name="acc_mng_first_name" placeholder="Enter first name" required value="{{ session()->get('publisher.acc_mng_first_name') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="amLastName" name="acc_mng_last_name" placeholder="Enter last name" required value="{{ session()->get('publisher.acc_mng_last_name') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="amEmail" name="acc_mng_email" placeholder="Enter email" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" required value="{{ session()->get('publisher.acc_mng_email') }}">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">
                                You must enter valid input
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control ml-2" id="amPhone" name="acc_mng_phone" placeholder="Enter phone number" value="{{ session()->get('publisher.acc_mng_phone') }}" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="amSkype" name="acc_mng_skype" placeholder="@username" value="{{ session()->get('publisher.acc_mng_skype') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
