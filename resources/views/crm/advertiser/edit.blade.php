            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST"
                          action="{{ route('advertiser.update', [$advertiser->id]) }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="dbaId" name="dbaId"
                                           ...
                                           value="{{ $advertiser->dbaId ??  old('dbaId') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="companyName" name="companyName"
                                           ...
                                           value="{{ $advertiser->companyName ?? old('companyName') }}" required>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="regId" name="regId"
                                           ...
                                           value="{{ $advertiser->regId ??  old('regId') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="vat" name="vat" placeholder="Enter VAT"
                                           value="{{ $advertiser->vat ??  old('vat') }}" required>
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="reportEmail" name="reportEmail"
                                           ...
                                           value="{{ $advertiser->reportEmail ??  old('reportEmail') }}" required>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="accEmail" name="accEmail"
                                           ...
                                           value="{{ $advertiser->accEmail ??  old('accEmail') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address1" name="address1"
                                           ...
                                           value="{{ $advertiser->address1 ??  old('address1') }}" required>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" id="country_id" required>
                                        ...
                                        @foreach ($countries as $key => $country)
                                            <option value="{{ $country->id }}"
                                                    @if(isset($advertiser) && $advertiser->country_id == $country->id )
                                                        selected="selected"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="amFirstName" name="amFirstName"
                                           placeholder="Enter first name" value="{{ $advertiser->amFirstName ??  old('amFirstName') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="amLastName" name="amLastName"
                                           placeholder="Enter last name" value="{{ $advertiser->amLastName ??  old('amLastName') }}" required>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="amEmail" name="amEmail"
                                           placeholder="Enter email" value="{{ $advertiser->amEmail ??  old('amEmail') }}">
                                </div>
                            </div>
                        </div> <!-- end row -->
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="amPhone" name="amPhone"
                                           placeholder="Enter phone number" value="{{ $advertiser->amPhone ??  old('amPhone') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="amSkype" name="amSkype"
                                               placeholder="@username" value="{{ $advertiser->amSkype ??  old('amSkype') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="amLinkedIn" name="amLinkedIn"
                                               placeholder="Url" value="{{ $advertiser->amLinkedIn ??  old('amLinkedIn') }}">
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row -->
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="revSharePer" name="revSharePer"
                                           placeholder="Enter Revenue Share (%)" value="{{ $advertiser->revSharePer ??  old('revSharePer') }}">
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bank" name="bank"
                                           placeholder="Enter Bank account" value="{{ $advertiser->revSharePer ??  old('revSharePer') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="payoneer" name="payoneer"
                                           placeholder="Enter payoneer account" value="{{ $advertiser->payoneer ??  old('payoneer') }}">
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="paypal" name="paypal"
                                           placeholder="Enter Paypal account" value="{{ $advertiser->paypal ??  old('paypal') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="notes" name="notes"
                                           placeholder="Enter notes / comments" value="{{ $advertiser->notes ??  old('notes') }}">
                                </div>
                            </div> <!-- end col -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="AgreementStartDate"
                                           name="AgreementStartDate" value="{{ $advertiser->agreement_start_date ??  old('AgreementStartDate') }}">
                                    <div class="invalid-feedback">
